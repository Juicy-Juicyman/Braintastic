...
const GameOverScreen: React.FC<GameOverScreenProps> = ({ onPlayAgain }) => {
  return (
    <div className="text-center bg-white p-4 rounded shadow w-full max-w-md mx-auto">
      <h2 className="text-xl sm:text-2xl text-green-600 font-bold mb-2">Congratulations!</h2>
      <p className="text-sm sm:text-lg text-gray-700 mb-4">You matched all pairs correctly.</p>
      <button
        onClick={onPlayAgain}
