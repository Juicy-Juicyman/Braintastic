...
const GameOverScreen: React.FC<GameOverScreenProps> = ({ onPlayAgain }) => {
  return (
    <div className="text-center bg-white p-4 rounded shadow w-full max-w-md mx-auto">
      <h2 className="text-xl sm:text-2xl text-purple-600 font-bold mb-2">
        Congratulations!
      </h2>
      ...
      <button
        onClick={onPlayAgain}
        className="px-4 sm:px-6 py-2 sm:py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-800 transition font-semibold text-sm sm:text-lg"
      >
        Play Again
      </button>
    </div>
